...
@section('page-title', 'Edit Subcategory: ' . $subcategory->name)
...
<div class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl shadow-lg mb-8 p-6 text-white">
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-3xl font-bold mb-2">Edit Subcategory</h1>
            <p class="text-orange-100">Update subcategory information and settings</p>
        </div>
        <div class="flex space-x-3">
            <a href="{{ route('admin.subcategories.show', $subcategory->id) }}" class="bg-white bg-opacity-20 hover:bg-opacity-30 text-white px-4 py-2 rounded-lg font-medium transition-all duration-300 hover:scale-105">
                <i class="fas fa-eye mr-2"></i> View Subcategory
            </a>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4">
                                <label class="flex items-center">
                                    <input type="radio" name="status" value="1" {{ old('status', $subcategory->status ? '1' : '0') == '1' ? 'checked' : '' }} 
                                           class="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300">
                                    <span class="ml-2 text-sm text-gray-700">Active</span>
                                </label>
                                <label class="flex items-center">
                                    <input type="radio" name="status" value="0" {{ old('status', $subcategory->status ? '1' : '0') == '0' ? 'checked' : '' }} 
                                           class="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300">
                        ...
                        <div>
                            <label class="flex items-center">
                                <input type="checkbox" name="featured" value="1" {{ old('featured', $subcategory->featured) ? 'checked' : '' }} 
                        ...
                        <div>
                            <label class="flex items-center">
                                <input type="checkbox" name="nav" value="1" {{ old('nav', $subcategory->nav) ? 'checked' : '' }} 
                                       class="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded">
                        ...
                        <div>
                            ...
                            <input type="number" id="sort_order" name="sort_order" value="{{ old('sort_order', $subcategory->sort_order) }}" 
            ...
            <div class="space-y-6">
                ...
                @if($subcategory->image)
                    <div class="bg-gray-50 rounded-lg p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Current Image</h3>
                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">
                        {{ $subcategory->image ? 'Update Image' : 'Subcategory Image' }}
                    </h3>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                                {{ $subcategory->image ? 'Upload New Image' : 'Upload Image' }}
                            </label>
                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="meta_title" name="meta_title" value="{{ old('meta_title', $subcategory->meta_title) }}" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                        ...
                        <div>
                            ...
                            <textarea id="meta_description" name="meta_description" rows="3" 
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                                      placeholder="SEO description for search engines">{{ old('meta_description', $subcategory->meta_description) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>

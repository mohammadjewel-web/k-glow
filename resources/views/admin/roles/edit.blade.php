...
<div class="max-w-3xl mx-auto py-6">
    <h1 class="text-2xl font-bold text-[--brand-orange] mb-4">Edit Role - {{ $role->name }}</h1>
    ...
    <form action="{{ route('admin.roles.update', $role->id) }}" method="POST"
        ...
        <button type="submit"
            class="bg-[--brand-orange] text-white px-6 py-2 rounded hover:bg-orange-600 transition">Update Role</button>
    </form>
</div>
@endsection
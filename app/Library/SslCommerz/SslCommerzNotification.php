...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    public function __construct()
    {
        ...
        \Log::info('SSLCommerz library config:', [
            'store_id' => $this->config['apiCredentials']['store_id'] ?? 'NOT SET',
            'store_password' => $this->config['apiCredentials']['store_password'] ? 'SET' : 'NOT SET',
            'api_domain' => $this->config['apiDomain'] ?? 'NOT SET'
        ]);
    ...
    public function setAuthenticationInfo()
    {
        ...
        $storePassword = $this->getStorePassword();
        
        // Debug authentication info
        \Log::info('SSLCommerz authentication info:', [
            'store_id' => $storeId,
            'store_password' => $storePassword ? 'SET' : 'NOT SET'
        ]);
        
        $this->data['store_id'] = $storeId;
        $this->data['store_passwd'] = $storePassword;
